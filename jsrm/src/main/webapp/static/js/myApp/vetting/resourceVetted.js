 ...
 */
var pagination = new Pagination(getBasePath() + "/vettingRest/queryResourceVetted", "page", function (data) {
    fillTableData(data)
});
    ...
    if(data.length < 1){
        ...
        if (data != undefined) {
            for (var i = 0; i < data.length; i++) {
                ...
                var  resourceType = getVlaue(data[i].resourceTypeOneLevelValue);
