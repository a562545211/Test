/**
 * Created by 13140 on 2016/11/20.
 */
/**
...
function resourceStatistics(params) {
    $.ajax({
        type:"post",
        url:getBasePath()+"statisticalAnalysis/getResourceClassificationStaticLeader",
        dataType:"json",
        data:params,
        success:function (data) {
            if(data.status==0){
...
function resourceType(params) {
    $.ajax({
        type:"post",
        url:getBasePath()+"statisticalAnalysis/getResourceFormStaticLeader",
        dataType:"json",
        data:params,
        success:function (data) {
            if(data.status==0){
